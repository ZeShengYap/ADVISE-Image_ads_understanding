...
def main(args):
  ...
  print(f'Load symbol annotations for {len(symbol_annots)} images.')
  ...
  print(f'Load {len(word_to_id)} pairs of mapping.')
  print(f'Symbol list: \n{json.dumps(id_to_symbol, indent=2)}')
  ...
  print(f'Export {len(results)} symbols')
  print('Done')
